    ...
    ObsidianGit.prototype.onInit = function () {
        ...
        this.addCommand({
            ...
            callback: function () { return __awaiter(_this, void 0, void 0, function () {
                ...
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0: return [4 /*yield*/, this.git.add('./*').commit("vault backup").push("origin", "master", null, function () { new obsidian.Notice("Pushed!"); })];
                        case 1:
                            result = _a.sent();
