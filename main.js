...
var ObsidianGit = /** @class */ (function (_super) {
    ...
    ObsidianGit.prototype.onload = function () {
        return __awaiter(this, void 0, void 0, function () {
            var adapter, git, isValidRepo, _a;
            var _this = this;
                    ...
                    case 1:
                                ...
                                return __generator(this, function (_a) {
                                    switch (_a.label) {
                                        case 0:
                                            ...
                                            return [4 /*yield*/, this.pullForUpdates()];
                                        case 1:
                                            filesAffected = _a.sent();
                                            if (filesAffected > 0) {
                                                new obsidian.Notice("Pulled new changes. " + filesAffected + " files affected.");
                                            }
                                            else {
                                                new obsidian.Notice("Everything is up-to-date.");
                                            }
                                            return [2 /*return*/];
                                    }
                                });
                        ...
                        this.addCommand({
                            ...
                            callback: function () { return __awaiter(_this, void 0, void 0, function () {
                                return __generator(this, function (_a) {
                                    switch (_a.label) {
                                        case 0: return [4 /*yield*/, this.isRepoClean()];
                                        case 1:
                                            if (!_a.sent()) return [3 /*break*/, 2];
                                            new obsidian.Notice("No updates detected. Nothing to push.");
                                            return [3 /*break*/, 4];
                                        case 2:
                                            new obsidian.Notice("Pushing changes to remote repository..");
                                            return [4 /*yield*/, this.addCommitAndPush()];
                                        case 3:
                                            _a.sent();
                                            _a.label = 4;
    ...
    ObsidianGit.prototype.isRepoClean = function () {
        return __awaiter(this, void 0, void 0, function () {
            var status;
            return __generator(this, function (_a) {
                switch (_a.label) {
    ...
    ObsidianGit.prototype.pullForUpdates = function () {
        return __awaiter(this, void 0, void 0, function () {
            var pullResult;
            return __generator(this, function (_a) {
                switch (_a.label) {
    ...
    ObsidianGit.prototype.addCommitAndPush = function (message) {
        if (message === void 0) { message = "Pushed changes to remote repository."; }
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.git
                            .add("./*")
                            .commit(this.settings.commitMessage)
                            .push("origin", "master", null, function (err) {
                            new obsidian.Notice(err ? err.message : message);
                        })];
                    case 1:
                        _a.sent();
                        return [2 /*return*/];
    ...
    ObsidianGit.prototype.enableAutosave = function () {
        var _this = this;
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    ...
                    case 1:
                        ...
                        // console.log("repo clean?", await this.isRepoClean());
                        return [3 /*break*/, 3];
                        return [4 /*yield*/, this.addCommitAndPush("Autosave: pushed changes!")];
                    case 2:
                        _a = (_b.sent());
                        _b.label = 3;
                    case 3:
    ...
    ObsidianGit.prototype.disableAutosave = function () {
        if (this.intervalID) {
...
var ObsidianGitSettings = /** @class */ (function () {
    function ObsidianGitSettings() {
        this.commitMessage = "vault backup";
...
var ObsidianGitSettingsTab = /** @class */ (function (_super) {
    ...
    ObsidianGitSettingsTab.prototype.display = function () {
        ...
        new obsidian.Setting(containerEl)
            .setName("Autosave")
            .setDesc("Commit and push changes every X minutes. To disable autosave, specify negative value or zero (default)")
            .addText(function (text) {
            return text
                ...
                if (!isNaN(Number(value))) {
                    ...
                    if (plugin.settings.autoSaveInterval > 0) {
                        ...
                        new obsidian.Notice("Autosave enabled! Every " + plugin.settings.autoSaveInterval + " minutes.");
                    }
                    else if (plugin.settings.autoSaveInterval <= 0 &&
                        plugin.intervalID) {
                        plugin.disableAutosave() && new obsidian.Notice("Autosave disabled!");
                    }
                }
                else {
